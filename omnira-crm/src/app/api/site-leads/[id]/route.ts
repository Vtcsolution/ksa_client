...
/** Proxies status/priority/star/assignee/note updates to the Website — see /api/site-leads (GET) for the read-side of this same proxy pair. */
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const res = await fetch(`${websiteUrl}/api/leads/${id}`, {
      method: "PATCH",
